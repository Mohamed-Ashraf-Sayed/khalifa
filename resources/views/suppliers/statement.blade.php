...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 no-print">
        ...
        <div class="d-flex gap-2">
            ...
            @if($supplier->phone)
                @php
                    $waPhone = preg_replace('/\D+/', '', $supplier->phone);
    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="text-center mb-3">
                <h4 class="m-0">كشف حساب مورّد</h4>
                <div class="text-muted">{{ $supplier->name }}{{ $supplier->company_name ? ' — ' . $supplier->company_name : '' }}</div>
            </div>
            <div class="row g-3">
                <div class="col-md-4"><div class="text-muted small">إجمالي المستحقّ (مدين)</div><div class="fw-bold fs-5 text-danger">{{ number_format((float) $totalDebit, 2) }}</div></div>
