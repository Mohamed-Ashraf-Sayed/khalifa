...
@section('content')
    <div class="row g-3 mb-3">
        <div class="col-md-4">
            <div class="statcard sc-danger h-100"><span class="sc-ic"><i class="fa-solid fa-money-check-dollar"></i></span><span><span class="sc-v d-block">{{ number_format($total, 2) }} ج</span><span class="sc-l d-block">إجمالي دفعات المقاولين</span></span></div>
        </div>
    </div>
