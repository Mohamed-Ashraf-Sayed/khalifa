    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-4"><div class="text-muted small">الفئة</div><div><span class="badge text-bg-light">{{ $categories[$expense->category] ?? $expense->category }}</span></div></div>
                ...
                <div class="col-md-4"><div class="text-muted small">مركز التكلفة</div><div>{{ $expense->costCenter?->name ?? '—' }}</div></div>
