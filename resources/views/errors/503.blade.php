...
<head>
    ...
    <title>503 — النظام تحت الصيانة — {{ config('app.name') }}</title>
...
<body>
    <div class="error-card">
        <div class="error-icon"><i class="fa-solid fa-screwdriver-wrench"></i></div>
        <div class="error-code">503</div>
        <div class="error-message">النظام تحت الصيانة</div>
